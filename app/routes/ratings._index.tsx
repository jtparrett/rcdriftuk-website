...
const Row = ({
  ...
  return (
    ...
    >
      ...
      <styled.td py={4}>
        <Link to={`/ratings/${driver.id}`} style={{ display: 'block' }}>
      ...
      <styled.td textAlign="right" py={4} pr={4} borderRightRadius="xl" fontFamily="mono">
        <styled.img
...
const RankSection = () => {
  ...
  return (
    <Box
      ...
      bgColor="black"
    >
      <Box borderWidth={1} borderColor="gray.900" rounded="xl" bgColor="gray.900">
        <Flex 
          p={4} 
          alignItems="center" 
              ...
              {Object.values(RANKS).map((rank) => {
                ...
                return (
                  ...
                  >
                    ...
                    <styled.p fontSize="sm" fontWeight="medium">{RANKS_RULES[rank]}</styled.p>
                  </Flex>
                );
              })}
            </Flex>
      ...
      <Container pb={12} px={2} pt={2} maxW={800}>
        ...
        >
          ...
          <Box
            ...
            bgColor="black"
          >
            <Box borderWidth={1} borderColor="gray.900" p={4} rounded="xl" bgColor="gray.950">
              <styled.table w="full" css={{ borderSpacing: "0 8px", borderCollapse: "separate" }}>
                <thead>
                  <tr>
                    <styled.th textAlign="left" pl={4} w="50px" color="gray.400">
                      #
                    </styled.th>
                    <styled.th textAlign="left" color="gray.400">Name</styled.th>
                    <styled.th textAlign="right" color="gray.400">Points</styled.th>
                    <styled.th textAlign="right" color="gray.400">Rank</styled.th>
                  </tr>
                </thead>
                <tbody>
                  {drivers
