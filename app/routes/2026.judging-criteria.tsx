...
export const meta: Route.MetaFunction = () => {
  return [
    { title: `${AppName} | 2026 Judging Criteria` },
    {
      name: "description",
      content:
        "Official judging criteria and scoring system for the 2026 season",
    },
    {
      property: "og:image",
        ...
        <Stack gap={4}>
          ...
          <CollapsibleCard title="2. Scoring Battles (Tandem Runs)">
            ...
            <UL>
              ...
              <styled.li>
                <Highlight>Major error</Highlight> (spin/off-track) results in a
                0 score for that run.
              </styled.li>
            </UL>
          ...
          <CollapsibleCard title="3. Major Errors – Zero Score (Incomplete Run)">
            ...
            <UL>
              ...
              <styled.li>
                ...
                track barriers/parmeters that disrupts the vehicle in any way
                results in a zero score for that run.
              </styled.li>
              <styled.li>
          ...
          <CollapsibleCard title="6. Additional Guidelines for Judges">
            ...
            <P>
              ...
              judging throughout the 2026 season.
            </P>
          </CollapsibleCard>
        </Stack>
      </Stack>
