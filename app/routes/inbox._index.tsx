...
const InboxPage = () => {
  ...
  const isRequests = searchParams.get("requests") !== null;
  ...
  return (
    <>
      <TabsBar>
        <Tab to="/inbox" isActive={!isRequests}>
          Inbox
        </Tab>
        <Tab to="/inbox?requests" isActive={isRequests}>
          Requests
        </Tab>
      </TabsBar>
            ...
            return (
              ...
              >
                      ...
                      style={
                        {
                          ...
                          "--align":
                            userIndex === 0 ? "flex-end" : "flex-start",
                ...
                <Box flex={1}>
                  ...
                  <LinkOverlay to={`/inbox/${thread.id}`}>
