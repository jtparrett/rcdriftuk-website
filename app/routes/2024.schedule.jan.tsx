...
const Page = () => {
  return (
    <Flex flexDir="column" gap={4} maxW={800} pt={4}>
      ...
      <styled.p>
        The national championship for RC drifting in the UK is proud to announce
        we will be attending the Autosport Show International 2024.
      </styled.p>
      <styled.p>
        We invite you to join us for the show and drive your RC car with others
        in front of 80,000 people over 4 days.
      </styled.p>
      <styled.p>
        These tickets will be sold on a first come first serve basis, we will
        create a reserve list if places for the event sell out. Tickets You will
        find 8 options available, 4 x are for driver tickets, 4 x are available
        for addtional people, This might be your Dad or partner. Tickets to
        attend the show retail at £40 per day. We are offering you a HUGE saving
        by offering you;
      </styled.p>
      <styled.ul>
